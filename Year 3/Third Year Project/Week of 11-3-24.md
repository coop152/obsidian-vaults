...
- [x] Got all the licenses in check (i believe, its kinda hard to tell if the program itself is under GPLv2 or if its all copyrighted, cause the files in the old README dont actually exist and everywhere seems to say it's GPL without actually indicating where they got it from)
# Un-C-ifying Lexer
