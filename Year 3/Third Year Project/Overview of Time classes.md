...
- `static int Size(int year)`: returns the number of days in a year. Just check if the year is a leap year and use 366 instead of 365. Maybe you can extend classes yourself in c++ to add this function? could be fun