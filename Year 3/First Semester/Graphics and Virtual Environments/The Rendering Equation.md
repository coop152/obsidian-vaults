...
This graph plots the wavelength of each colour against the response of each cone when exposed to it. For example, when exposed to a saturated blue with a wavelength of about 460nm, the S cone has a strong response while the M and L cones have similarly weak responses.
