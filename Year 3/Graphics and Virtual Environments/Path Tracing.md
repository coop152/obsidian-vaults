...
As an example of a Monte-Carlo technique, think how you might find the area of this shape:
![](Pasted%20image%2020231119170410.png)
Clearly there is no simple analytical solution for this, like there is for a circle. Let's consider the circle case, where there *is* a simple analytical solution, and then see how we could calculate the area without